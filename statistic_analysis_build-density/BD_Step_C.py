...
pca_data_path = r"C:/Users/athan/Documents/DATA STOKHOLM/ANALYSIS/Python_exports/BUILD_DENSITY/final_combined_with_pca_Build_Density.xlsx"
pca_data = pd.read_excel(pca_data_path)

# Dynamically select available PCA columns
pca_columns = [col for col in ['PC1', 'PC2'] if col in pca_data.columns]
...
silhouette_data_df.to_excel(r"C:/Users/athan/Documents/DATA STOKHOLM/ANALYSIS/Python_exports/BUILD_DENSITY/silhouette_data_Build_Density.xlsx", index=False)

elbow_data_df = pd.DataFrame({
    'Number of Clusters (k)': cluster_values,
    'WCSS': wcss
})
elbow_data_df.to_excel(r"C:/Users/athan/Documents/DATA STOKHOLM/ANALYSIS/Python_exports/BUILD_DENSITY/elbow_data_Build_Density.xlsx", index=False)
...
# Display both plots
plt.tight_layout()
plt.savefig(r"C:/Users/athan/Documents/DATA STOKHOLM/ANALYSIS/Python_exports/BUILD_DENSITY/Optical_Num_of_Clusters_Silhouette+Elbow_Build_Density.png")
plt.show()
