...
Build_Density_data = pd.read_excel(r"C:/Users/athan/Documents/DATA STOKHOLM/ANALYSIS/Python_imports/Build_Density_NoZeros.xlsx")

# Step 2: Select the columns to normalize (columns 11 to 12)
# In Python, iloc[:, 10:12] means selecting columns 11 to 12 (zero-indexed)
columns_to_normalize = Build_Density_data.iloc[:, 10:12]
...
final_df = pd.concat([Build_Density_data, normalized_df], axis=1)

# Step 6: Save the combined data (original + normalized) to an Excel file
output_excel_path = r"C:/Users/athan/Documents/DATA STOKHOLM/ANALYSIS/Python_exports/BUILD_DENSITY/normalized_Build_Density.xlsx"
