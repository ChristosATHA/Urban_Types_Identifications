...
# Assuming PCA columns are named 'PC1', 'PC2', 'PC3', 'PC4', 'PC5'
...
pca_df.to_excel(fr"C:/Users/athan/Documents/DATA STOKHOLM/ANALYSIS/Python_exports/network_clusters_{suffix}.xlsx", index=False)
